...
public class AtlasPacker : EditorWindow {
    int blockSize = 16; // 16 pixels per block/texture
    ...
    private void OnGUI() {
        ...
        if (GUILayout.Button("Save Atlas")) {
            ...
            try {
                ...
                Debug.Log("Atlas Packer: Texture saved.");
            } catch {
                Debug.Log("Atlas Packer: Texture could not be saved.");
            }
        }
    }
    ...
    void LoadTextures() {
        ...
        rawTextures = Resources.LoadAll("minecraft", typeof(Texture2D));
        ...
        Debug.Log("Atlas packer: Minecraft Texture Loaded: " + sortedTextures.Count);
    }
